...
Pcre2Pattern::~Pcre2Pattern() { pcre2_code_free(re); }

pcre2_code *Pcre2Pattern::get() const { return re; }
...
Pcre2MatchData::~Pcre2MatchData() { pcre2_match_data_free(match_data); }

pcre2_match_data *Pcre2MatchData::get() const { return match_data; }