...
void Decoder::init() {
    ...
    if (avformat_open_input(
            &fmt_ctx_, input_filename_.c_str(), nullptr, nullptr) < 0) {
...
void Decoder::processFrame() {
    ...
    std::string cur_str =
        Utils::formatTime(std::chrono::seconds(static_cast<long>(current_pts)));
    fmt::print(stdout,
               "  {:<{}}: {} / {}\r",
               "position",
               WIDTH,
